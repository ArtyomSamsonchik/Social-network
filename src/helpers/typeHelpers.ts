...
type ActionCreatorReturnType<A extends AnyAction> = A | ThunkAction<any, any, any, A>
...
export type MapActionCreators<C extends ComponentType<any>, K extends PropsKeysType<C>, A extends Action = AnyAction> = {
    [P in K]: (...args: Parameters<PropsType<C>[P]>) => ActionCreatorReturnType<A>
}

//  ActionCreatorReturnType<A, ReturnType<PropsType<C>[P]>>